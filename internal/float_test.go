...
func TestFloat(t *testing.T) {
	...
	require.Assignable(t, typ.Float, newtype.FloatRange(3.1, 5.8))
	require.Assignable(t, typ.Float, vf.Float(4.2).Type())
	require.Equal(t, typ.Float, typ.Float)
	require.Equal(t, typ.Float, newtype.FloatRange(-math.MaxFloat64, math.MaxFloat64))
...
func TestFloatExact(t *testing.T) {
	...
	require.Assignable(t, newtype.FloatRange(3.0, 5.0), tp)
	require.Assignable(t, tp, newtype.FloatRange(3.1415927, 3.1415927))
	require.NotAssignable(t, tp, typ.Float)
	require.Equal(t, tp, newtype.FloatRange(3.1415927, 3.1415927))
	require.NotEqual(t, tp, newtype.FloatRange(2.1, 5.5))
...
func TestFloatRange(t *testing.T) {
	tp := newtype.FloatRange(3.1, 5.8)
	require.Instance(t, tp, 3.1415927)
	require.NotInstance(t, tp, 3.01)
	require.NotInstance(t, tp, true)
	require.Assignable(t, tp, newtype.FloatRange(3.1, 5.8))
	require.Assignable(t, tp, newtype.FloatRange(4.2, 4.2))
	require.Assignable(t, tp, vf.Float(4.2).Type())
	require.NotAssignable(t, tp, newtype.FloatRange(2.5, 5.5))
	require.NotAssignable(t, tp, newtype.FloatRange(3.1, 6.2))
	require.NotAssignable(t, tp, vf.Float(6.0).Type())
	require.NotAssignable(t, tp, typ.Float)
	require.Equal(t, tp, newtype.FloatRange(5.8, 3.1))
	require.NotEqual(t, tp, newtype.FloatRange(2.5, 5.5))
	require.NotEqual(t, tp, typ.Float)
	require.Equal(t, tp.Min(), 3.1)
	require.Equal(t, tp.Max(), 5.8)
	require.Equal(t, vf.Float(4.2).Type(), newtype.FloatRange(4.2, 4.2))
