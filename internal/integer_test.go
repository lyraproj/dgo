...
func TestInteger(t *testing.T) {
	...
	require.Assignable(t, typ.Integer, newtype.IntegerRange(3, 5))
	require.Assignable(t, typ.Integer, vf.Integer(4).Type())
	require.Equal(t, typ.Integer, typ.Integer)
	require.Equal(t, typ.Integer, newtype.IntegerRange(math.MinInt64, math.MaxInt64))
...
func TestIntegerExact(t *testing.T) {
	...
	require.Assignable(t, newtype.IntegerRange(3, 5), tp)
	require.Assignable(t, tp, newtype.IntegerRange(3, 3))
	require.NotAssignable(t, tp, typ.Integer)
	require.Equal(t, tp, newtype.IntegerRange(3, 3))
	require.NotEqual(t, tp, newtype.IntegerRange(2, 5))
...
func TestIntegerRange(t *testing.T) {
	tp := newtype.IntegerRange(3, 5)
	require.Instance(t, tp, 3)
	require.NotInstance(t, tp, 2)
	require.NotInstance(t, tp, true)
	require.Assignable(t, tp, newtype.IntegerRange(3, 5))
	require.Assignable(t, tp, newtype.IntegerRange(4, 4))
	require.Assignable(t, tp, vf.Integer(4).Type())
	require.NotAssignable(t, tp, newtype.IntegerRange(2, 5))
	require.NotAssignable(t, tp, newtype.IntegerRange(3, 6))
	require.NotAssignable(t, tp, vf.Integer(6).Type())
	require.Equal(t, tp, newtype.IntegerRange(5, 3))
	require.NotEqual(t, tp, newtype.IntegerRange(2, 5))
	require.NotEqual(t, tp, newtype.IntegerRange(3, 4))
	require.NotEqual(t, tp, typ.Integer)
	require.Equal(t, tp.Min(), 3)
	require.Equal(t, tp.Max(), 5)
	require.Equal(t, vf.Integer(4).Type(), newtype.IntegerRange(4, 4))
