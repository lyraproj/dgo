...
import (
	...
	"github.com/lyraproj/dgo/test/util"
)
...
func Assignable(t *testing.T, a, b dgo.Type) {
	if !a.Assignable(b) {
		t.Helper()
		t.Fatalf(`%v is not a assignable from %v`, a, b)
	}
}
...
func NotAssignable(t *testing.T, a, b dgo.Type) {
	if a.Assignable(b) {
		t.Helper()
		t.Fatalf(`%v is assignable from %v`, a, b)
	}
}
...
func Instance(t *testing.T, typ dgo.Type, val interface{}) {
	if !typ.Instance(val) {
		t.Helper()
		t.Fatalf(`%v is not an instance of %v`, internal.Value(val), typ)
	}
}
...
func NotInstance(t *testing.T, typ dgo.Type, val interface{}) {
	if typ.Instance(val) {
		t.Helper()
		t.Fatalf(`%v is an instance of %v`, internal.Value(val), typ)
	}
}
...
func Equal(t *testing.T, a, b interface{}) {
	...
	if !va.Equals(b) {
		t.Helper()
		t.Fatalf(`%v is not equal to %v`, va, internal.Value(b))
	}
}
...
func NotEqual(t *testing.T, a, b interface{}) {
	...
	if va.Equals(b) {
		t.Helper()
		t.Fatalf(`%v is equal to %v`, va, internal.Value(b))
	}
}
...
func Match(t *testing.T, a, b interface{}) {
	if !util.IsMatch(a, b) {
		t.Helper()
		t.Fatalf(`'%v' does not match '%v'`, internal.Value(b), internal.Value(a))
	}
}
...
func NoMatch(t *testing.T, a, b interface{}) {
	if util.IsMatch(a, b) {
		t.Helper()
		t.Fatalf(`'%v' matches '%v'`, internal.Value(b), internal.Value(a))
	}
}
...
func Error(t *testing.T, msg interface{}, err error) {
	t.Helper()
	if err == nil {
		t.Fatalf(`Expected error matching '%v' did not occur`, internal.Value(msg))
	} else if !util.IsMatch(msg, err.Error()) {
		t.Fatalf(`Expected error matching '%v', got '%s'`, internal.Value(msg), err.Error())
	}
}
...
func Nil(t *testing.T, v interface{}) {
	if !(internal.Nil == v || v == nil) {
		t.Helper()
		t.Fatalf(`%v is not nil`, internal.Value(v))
	}
}
...
func NotNil(t *testing.T, v interface{}) {
	if v == nil {
		t.Helper()
		t.Fatalf(`%v is nil`, internal.Value(v))
	}
}
